...
--- As of 01.01.2023, kostra2010R is officially replaced by kostra2020 (see [dimfalk/kostra2020](https://github.com/dimfalk/kostra2020)). ---
...
```
In order to respect statistical uncertainties, as proposed in Malitz & Ertel (2015), ranging between 10 % and 20 % as a function of the chosen return period, make use of `uncertain = TRUE` to get an interval centered around the single value above.
...
Since KOSTRA-2010R has an upper limit of Tn = 100 a, we can make use of e.g. PEN-LAWA method in order to extrapolate statistical precipitation depths for all duration levels.
